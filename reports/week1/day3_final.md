...
### Aishee
- [x] Investigated the class-taxonomy question raised by Adrija; traced the extra
      codes to their source (Maeda et al. 2018 classification, documented in the
      RDD2022 paper's own Table 1)
- [x] Finalized revised label-mapping decision — see `docs/label_mapping_decision.md`
...
- **Class taxonomy was more complex than assumed:** RDD2022's raw India/Japan data
  ...
  identified (mixed pavement-deterioration and road-marking-deterioration codes from
  the original Japanese classification scheme). Resolved same day, but cost roughly
  half a day of Adrija's planned work.
- **D50 remains unresolved** — no confirmed definition found for this specific
  dataset; excluded from training pending further research (see follow-up item in
  the decision document), representing 10.9% of instances.
